    ...
    <footer className="flexCenter flex-col border-t dark:border-nft-black-1 border-nft-gray-1 sm:py-8 py-16">
      <div className="w-full minmd:w-4/5 flex flex-row md:flex-col sm:px-4 px-16">
        ...
        <div className="flex-1 flexBetweenStart flex-wrap ml-10 md:ml-0 md:mt-8 cursor-pointer">
          <FooterLinks heading={appName} items={[['Explore', '/'], ['How it Works', '/how-it-works'], ['Contact Us', '/contact-us'], ['About Us', '/about'], ['Swap Token', '/swap-token']]} />
          <FooterLinks heading="Support" items={[['Follow us on Twitter', 'https://twitter.com/BlockchainNG'], ['Follow us on Instagram', 'https://www.instagram.com/blockchainnigeria/'], ['Follow us on Facebook', 'https://www.facebook.com/BlockchainNG'], ['Join us on Telegram', 'https://t.me/+T7VwGW-Ftwh60LhF'], ['Join BNUGDAO', ' https://snapshot.org/#/bnugdao.eth'], ['Drop us a mail', 'info@blockchainnigeria.group']]} extraClasses="ml-4" />
        </div>
      </div>
