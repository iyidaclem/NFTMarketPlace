...
// File contracts/BNUGToken.sol

// contracts/GLDToken.sol
pragma solidity ^0.8.0;
contract BNUGToken is ERC20, Ownable {
    /**
     * @notice isAdmin is a status to check if 
    ...
    constructor(uint256 initialSupply) ERC20("BNUG", "BNUG") {
    ...
    function setAdmin(address new_admin) onlyOwner public {
        ...
        for (uint16 i = 0; i < admins.length; i++)
        {
        ...
        admins[admins.length] = new_admin;
    }
    ...
    */ 
     ...
     */
    function renounceAdminship() _onlyAdmin public
    {
     ...
     */
    function minCommunityToken(address account, uint256 amount) _onlyAdmin public
    {
    ...
    function burnToken(address account, uint256 amount) _onlyAdmin public 
    {
